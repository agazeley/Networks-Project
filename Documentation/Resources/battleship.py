...
def run_game ():
    ...
    ship_objs = [ 'battleship' , 'cruiser1' , 'cruiser2' , 'destroyer1' , 'destroyer2' , 'destroyer3' , 'submarine1' ,
                  'submarine2' , 'submarine3' , 'submarine4' ]  # List of the ships available
    main_board = add_ships_to_board ( main_board ,
    ...
    while True:
        ...
        if tilex != None and tiley != None:
            ...
            if not revealed_tiles[ tilex ][
                ...
                if check_revealed_tile ( main_board ,
...
def check_for_win ( board , revealed ):
    ...
    for tilex in range ( BOARDWIDTH ):
        for tiley in range ( BOARDHEIGHT ):
            if board[ tilex ][ tiley ] != None and not revealed[ tilex ][
                tiley ]:  # check if every board with a ship is revealed, return false if not
                return False
    return True
...
def add_ships_to_board ( board , ships ):
    ...
    for ship in ships:  # go through each ship declared in the list
        ...
        while not valid_ship_position:
            ...
            valid_ship_position , ship_coords = make_ship_position ( new_board , xStartpos , yStartpos , isHorizontal ,
                                                                     ship_length , ship )
...
def show_help_screen ():
    ...
    """
    line1_surf , line1_rect = make_text_objs ( 'Press a key to return to the game' , BASICFONT , TEXTCOLOR )
    line1_rect.topleft = (TEXT_LEFT_POSN , TEXT_HEIGHT)
    DISPLAYSURF.blit ( line1_surf , line1_rect )

    line2_surf , line2_rect = make_text_objs ( 'This is a battleship puzzle game. Your objective is ' \
    ...
    line5_surf , line5_rect = make_text_objs ( 'the "New Game" button.' , BASICFONT , TEXTCOLOR )
...
def show_gameover_screen ( shots_fired ):
    ...
    pressKeySurf , pressKeyRect = make_text_objs ( 'Press a key to try to beat that score.' , BASICFONT , TEXTCOLOR )
